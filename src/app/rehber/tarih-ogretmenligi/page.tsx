...
export default function TarihOgretmenligiPage() {
  ...
  const { updates } = useCommunityUpdates('tarih-ogretmenligi');
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 pb-20">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
          <a
            href="https://t.me/+2eiD7JHFg_U1MTJi"
            target="_blank"
          ...
          >
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="font-bold text-white text-lg mb-1">Tarih Öğretmenleri</div>
        ...
        <Tabs value={activeTab} onValueChange={(tab: string) => setActiveTab(tab)} className="space-y-8">
          ...
          <TabsContent value="updates" className="space-y-6">
            <PageCommunityUpdatesContent
              categorySlug="tarih-ogretmenligi"
              updates={updates}
              groupName="Tarih Öğretmenleri Grubu"
              telegramUrl="https://t.me/+2eiD7JHFg_U1MTJi"
            />
          </TabsContent>
