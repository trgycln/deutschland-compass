            ...
            >
              ...
              <div className="relative flex items-center gap-3.5 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-bold text-white text-base sm:text-lg mb-0.5">Yemek & Helal Mekanlar</div>
                  <div className="text-xs sm:text-sm text-blue-100">Telegram Grubu · Şehirlerde yemek mekanları dayanışması</div>
                </div>
                ...
                <div className="mt-8 p-4 sm:p-5 bg-gradient-to-r from-amber-500/10 via-sky-500/10 to-emerald-500/10 rounded-2xl border border-amber-200/80 dark:border-amber-800/40 flex flex-col sm:flex-row items-center justify-between gap-4">
                  <div className="text-left flex-1">
                    ...
                    <p className="text-xs text-slate-600 dark:text-slate-400">
                      Telegram kanalımıza (<span className="font-semibold text-slate-800 dark:text-slate-200">@deutschlandcompassin</span>) ve <span className="font-semibold text-slate-800 dark:text-slate-200">Yemek & Helal Mekanlar</span> grubumuza katılarak yeni tavsiyelerden anında haberdar olun.
                    </p>
                  </div>
                  <div className="flex items-center gap-2 shrink-0 flex-wrap">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-3.5 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded-xl shadow-md hover:shadow-lg transition-all active:scale-95 inline-flex items-center gap-1.5"
                    >
                      <span>Mekan Grubuna Katıl</span>
