...
export default function VeterinerHekimligiPage() {
  ...
  const { updates } = useCommunityUpdates('veteriner-hekimligi');
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 pb-20">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <a href="https://t.me/+TsOB4-D8q1A4ZjA6" target="_blank" rel="noopener noreferrer" className="block group relative overflow-hidden rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="font-bold text-white text-lg mb-1">Veteriner Hekimliği</div>
        ...
        <Tabs value={activeTab} onValueChange={(tab: string) => setActiveTab(tab)} className="space-y-8">
          ...
          <TabsContent value="updates" className="space-y-6">
            <PageCommunityUpdatesContent
              categorySlug="veteriner-hekimligi"
              updates={updates}
              groupName="Veteriner Hekimler Grubu"
              telegramUrl="https://t.me/+TsOB4-D8q1A4ZjA6"
            />
          </TabsContent>
