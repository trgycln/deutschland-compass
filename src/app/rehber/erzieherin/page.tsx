...
import { BookOpen, Baby, GraduationCap, FileText, Briefcase, Globe, Building2, Quote, Calendar, User, AlertTriangle, Heart, Users, ArrowRight } from 'lucide-react';
...
export default function ErzieherinGuidePage() {
  ...
  const { updates } = useCommunityUpdates('erzieherin');
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
          <a href="https://t.me/+V03ZgVzm6XAxNDVi" target="_blank" rel="noopener noreferrer" className="block group relative overflow-hidden rounded-xl bg-gradient-to-br from-purple-600 to-indigo-700 p-5 shadow-md hover:shadow-xl transition-all duration-300 hover:scale-[1.01]">
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="font-bold text-white text-lg mb-0.5">Erzieher / Erzieherin</div>
                <div className="text-xs text-purple-100">Telegram Grubu</div>
              </div>
