...
export default function SosyalBilgilerPage() {
  ...
  const { updates } = useCommunityUpdates('sosyal-bilgiler-ogretmenligi');
            ...
            <Tabs value={activeTab} onValueChange={(tab: string) => setActiveTab(tab)} className="space-y-8">
              ...
              <TabsContent value="updates" className="space-y-6">
                <PageCommunityUpdatesContent
                  categorySlug="sosyal-bilgiler-ogretmenligi"
                  updates={updates}
                  groupName="Sosyal Bilgiler Öğretmenliği Grubu"
                  telegramUrl="https://t.me/+mmWG2yO-r6wwODgy"
                />
              </TabsContent>
