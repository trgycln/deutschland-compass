...
export default function SinifOgretmenligiPage() {
  ...
  const { updates } = useCommunityUpdates('sinif-ogretmenligi');
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <a
            href="https://t.me/+Aahvl0R4RLI2M2Zi"
            target="_blank"
          ...
          >
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="font-bold text-white text-lg mb-1">Sınıf Öğretmenleri</div>
            ...
            <Tabs value={activeTab} onValueChange={(tab: string) => setActiveTab(tab)} className="space-y-8">
              ...
              <TabsContent value="updates" className="space-y-6">
                <PageCommunityUpdatesContent
                  categorySlug="sinif-ogretmenligi"
                  updates={updates}
                  groupName="Sınıf Öğretmenleri Grubu"
                  telegramUrl="https://t.me/+Aahvl0R4RLI2M2Zi"
                />
              </TabsContent>
