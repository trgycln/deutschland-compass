...
export default function HastaYasliBakimiPage() {
  ...
  const { updates } = useCommunityUpdates('hasta-yasli-bakimi');
      ...
      <div className="relative bg-red-900 text-white py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
            <a href="https://t.me/+j57ECmTyGfowYTFi" target="_blank" rel="noopener noreferrer" className="block group relative overflow-hidden rounded-xl bg-gradient-to-br from-red-600 to-rose-700 p-5 shadow-md hover:shadow-xl transition-all duration-300 hover:scale-[1.01]">
              ...
              <div className="relative flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-bold text-white text-lg mb-0.5">Pfleger/in & Bakım</div>
                  <div className="text-xs text-red-100">Telegram Grubu</div>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <PageCommunityUpdatesBanner 
              categorySlug="hasta-yasli-bakimi"
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
              <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 p-1 bg-slate-100 dark:bg-slate-800 rounded-xl gap-1">
                ...
                <TabsTrigger value="documents" className="rounded-lg py-2.5 data-[state=active]:bg-white dark:data-[state=active]:bg-slate-950 data-[state=active]:shadow-sm">Dokümanlar</TabsTrigger>
              </TabsList>
