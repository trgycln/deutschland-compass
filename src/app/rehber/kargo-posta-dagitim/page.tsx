...
export default function LogisticsGuidePage() {
  ...
  const { updates } = useCommunityUpdates('kargo-posta-dagitim');
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="bg-white dark:bg-slate-900 border-b">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
            <a href="https://t.me/+BZ_LmLEzumliMmZi" target="_blank" rel="noopener noreferrer" className="block group relative overflow-hidden rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
              ...
              <div className="relative flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-bold text-white text-lg mb-1">Kargo & Posta Dagitim</div>
      ...
      <div id="content-section" className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <PageCommunityUpdatesBanner 
          categorySlug="kargo-posta-dagitim"
          groupName="DEUTSCHE POST/AMAZON/HERMES/UBER DAĞITIM"
