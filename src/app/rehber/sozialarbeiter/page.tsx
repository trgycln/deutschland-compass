...
export default function SozialarbeiterPage() {
  ...
  const { updates } = useCommunityUpdates('sozialarbeiter');

  useEffect(() => {
    if (typeof window !== 'undefined') {
      const urlParams = new URLSearchParams(window.location.search);
      const tabParam = urlParams.get('tab');
      if (tabParam && ['guide', 'updates', 'experiences', 'documents', 'faq'].includes(tabParam)) {
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <a href="https://t.me/+rl7Kcl0WoswzOGNi" target="_blank" rel="noopener noreferrer" className="block group relative overflow-hidden rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="font-bold text-white text-lg mb-1">Sozialarbeiter</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Tabs value={activeTab} onValueChange={(tab: string) => setActiveTab(tab)} className="space-y-8">
              <TabsList className="grid w-full grid-cols-5 p-1 bg-slate-100 dark:bg-slate-800 rounded-xl">
              ...
              <TabsContent value="updates" className="space-y-6">
                <PageCommunityUpdatesContent
                  categorySlug="sozialarbeiter"
                  updates={updates}
                  groupName="Sozialarbeiter/in Grubu"
                  telegramUrl="https://t.me/+rl7Kcl0WoswzOGNi"
                />
              </TabsContent>
