...
export default function OkulOncesiPage() {
  ...
  const { updates } = useCommunityUpdates('okul-oncesi-ogretmenligi');
            ...
            <Tabs value={activeTab} onValueChange={(tab: string) => setActiveTab(tab)} className="space-y-8">
              ...
              <TabsContent value="updates" className="space-y-6">
                <PageCommunityUpdatesContent
                  categorySlug="okul-oncesi-ogretmenligi"
                  updates={updates}
                  groupName="Okul Öncesi Öğretmenleri Grubu"
                  telegramUrl="https://t.me/+6u5KygA3rHE4MWEy"
                />
              </TabsContent>
