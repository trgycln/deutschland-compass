...
export default function MuhendisMimarPage() {
  ...
  const { updates } = useCommunityUpdates('muhendis-mimar');
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
          <a href="https://t.me/+B-3lNUlIUSw2OTAy" target="_blank" rel="noopener noreferrer" className="block group relative overflow-hidden rounded-xl bg-gradient-to-br from-blue-600 to-indigo-700 p-5 shadow-md hover:shadow-xl transition-all duration-300 hover:scale-[1.01]">
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="font-bold text-white text-lg mb-0.5">Mühendis & Mimar</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <PageCommunityUpdatesBanner 
              categorySlug="muhendis-mimar"
              groupName="MÜHENDİS VE MİMARLAR GRUBU"
