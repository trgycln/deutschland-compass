...
import { gisData } from '@/data/gis-data';
import { supabase } from '@/lib/supabase';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs';
import { BookOpen, Map, Code2, Route, Briefcase, Laptop, Globe, Building2, Quote, Calendar, User, AlertTriangle, HelpCircle } from 'lucide-react';
...
export default function GisGuidePage() {
  const { title, description, sections, faq, stats, videoUrl: defaultVideoUrl, analogy } = gisData;
  ...
  useEffect(() => {
    async function fetchPageData() {
      ...
      const { data: expData } = await supabase
        ...
        .select('*')
        .eq('status', 'approved')
        .or('profession.ilike.%GIS%,profession.ilike.%CBS%,profession.ilike.%Coğrafi%,profession.ilike.%Harita%')
      ...
      const { data: profData } = await supabase
        ...
        .eq('slug', 'cografi-bilgi-sistemleri')
        .single();
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start text-center md:text-left">
            <div className="flex-1 space-y-4 w-full">
              <div className="flex items-center justify-center md:justify-start gap-2">
                <Badge variant="outline" className="text-blue-600 border-blue-200 bg-blue-50">Bilişim & Mühendislik</Badge>
              ...
              <div className="flex justify-center md:justify-start gap-3 pt-4">
                ...
                <ShareExperienceDialog 
                  professionSlug="cografi-bilgi-sistemleri" 
                  defaultProfessionName="Coğrafi Bilgi Sistemleri (GIS)" 
                />
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
          <a href="https://t.me/+tTSAdmOAXZ9kMDc6" target="_blank" rel="noopener noreferrer" className="block group relative overflow-hidden rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="font-bold text-white text-lg mb-1">Coğrafi Bilgi Sistemleri GIS</div>
