...
import { foodEngineerData } from '@/data/food-engineer-data';
...
export default function FoodEngineerPage() {
  const [videoUrl, setVideoUrl] = useState(foodEngineerData.videoUrl);
  const [pageTitle, setPageTitle] = useState(foodEngineerData.title);
  const [pageDescription, setPageDescription] = useState(foodEngineerData.description);
  const [activeTab, setActiveTab] = useState('roadmap');
  const { updates } = useCommunityUpdates('gida-muhendisligi');
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start text-center md:text-left">
            <div className="flex-1 space-y-4 w-full">
              <div className="flex items-center justify-center md:justify-start gap-2">
                <Badge variant="outline" className="text-emerald-600 border-emerald-200 bg-emerald-50">Mühendislik</Badge>
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-4">
                {foodEngineerData.stats.map((stat, index) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-6">
                <a 
                  href="https://t.me/+xHvxEfupIsIzNzFi" 
                  target="_blank" 
                ...
                >
                  ...
                  <div className="relative z-10 flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-white font-semibold text-sm">Gıda Mühendisleri</div>
              ...
              <div className="flex justify-center md:justify-start gap-3 pt-4">
                ...
                <ShareExperienceDialog professionSlug="gida-muhendisligi" />
              </div>
            </div>
      ...
      <div id="roadmap-section" className="container mx-auto px-4 py-8 max-w-5xl">
        <PageCommunityUpdatesBanner 
          categorySlug="gida-muhendisligi"
          groupName="GIDA MÜHENDİSLERİ GRUBU" 
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
          <TabsList className="grid w-full grid-cols-2 md:grid-cols-6 lg:w-[860px] h-auto p-1 bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl">
            ...
            <TabsTrigger value="pedagogy" className="py-2.5 rounded-lg">Uygulama</TabsTrigger>
          ...
          <TabsContent value="updates">
            <PageCommunityUpdatesContent 
              ...
              groupName="GIDA MÜHENDİSLERİ GRUBU"
              telegramUrl="https://t.me/+xHvxEfupIsIzNzFi" 
            />
          </TabsContent>
          ...
          <TabsContent value="roadmap" className="space-y-8">
            <div className="grid gap-8">
              {foodEngineerData.roadmap.map((step, index) => (
              ...
              <Card className="md:col-span-2">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    ...
                    {foodEngineerData.pedagogy.title}
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-300">
                      {foodEngineerData.pedagogy.content}
                    </p>
                  </div>
                  
                  <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-md border border-yellow-100 dark:border-yellow-900/50">
                    <h4 className="font-semibold text-yellow-800 dark:text-yellow-200 mb-2">Sertifikalar ve Yetkinlikler</h4>
                    <p className="text-sm text-yellow-700 dark:text-yellow-300">
                      {foodEngineerData.pedagogy.specialNeeds}
                    </p>
                  </div>

                  <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-md border border-blue-100 dark:border-blue-900/50">
                    <h4 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">Kariyer Stratejileri</h4>
                    <p className="text-sm text-blue-700 dark:text-blue-300">
                      {foodEngineerData.pedagogy.resources}
                    </p>
                  </div>
                </CardContent>
              </Card>
          ...
          <TabsContent value="faq">
            <FaqSection professionSlug="gida-muhendisligi" initialFaqs={foodEngineerData.faq} />
          </TabsContent>
          ...
          <TabsContent value="experiences">
            <div className="space-y-8">
              {/* Static Experiences */}
              <div className="grid gap-6 md:grid-cols-2">
                {foodEngineerData.experiences.map((exp, index) => (
              ...
              <ExperienceSection professionSlug="gida-muhendisligi" />
            </div>
          </TabsContent>
          ...
          <TabsContent value="documents">
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                ...
                <UploadDocumentDialog professionSlug="gida-muhendisligi" />
              </div>
              <DocumentSection professionSlug="gida-muhendisligi" />
            </div>
          </TabsContent>
        </Tabs>
      </div>
