...
import { BookOpen, PlayCircle, GraduationCap, Users, HeartHandshake, ArrowLeft, CheckCircle2, Bug, FileText } from 'lucide-react';
...
export default function TesterPage() {
  ...
  const { updates } = useCommunityUpdates('yazilim-test-uzmanligi');
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start text-center md:text-left">
            <div className="flex-1 space-y-4 w-full">
              <div className="flex items-center justify-center md:justify-start gap-2">
                <Badge variant="secondary" className="bg-orange-600/20 text-orange-300 hover:bg-orange-600/30 border-orange-500/50">
                  QA & Testing
                </Badge>
      ...
      <div id="roadmap-section" className="container mx-auto px-4 py-8 max-w-5xl">
        <PageCommunityUpdatesBanner 
          categorySlug="yazilim-test-uzmanligi"
          groupName="IT Bilişim Grubu" 
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
          ...
          <TabsContent value="updates">
            <PageCommunityUpdatesContent 
              categorySlug="yazilim-test-uzmanligi"
              updates={updates} 
              title="Yazılım Test Uzmanlığı (QA)" 
              groupName="IT Bilişim Grubu"
              telegramUrl="https://t.me/+_5ox6dqGidcwOGMy" 
            />
          </TabsContent>
                ...
                <div key={index} className="relative pl-8 md:pl-0">
                  ...
                  <div className="flex gap-6">
                    ...
                    <div className="hidden md:flex flex-col items-center">
                      <div className="w-14 h-14 rounded-full bg-white border-2 border-orange-600 text-orange-600 flex items-center justify-center font-bold text-xl shadow-sm z-10">
                        {step.step}
                      </div>
                    </div>
          ...
          <TabsContent value="pedagogy">
            <div className="max-w-4xl mx-auto">
              <Card className="bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/30 border-orange-100 dark:border-orange-900">
                <CardHeader>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 pt-4">
                    <div className="bg-white/60 dark:bg-slate-900/60 rounded-lg p-4 border border-orange-100 dark:border-orange-900/50">
          ...
          <TabsContent value="faq">
            <FaqSection professionSlug="yazilim-test-uzmanligi" initialFaqs={faq} />
          </TabsContent>

          {/* Experiences Tab */}
          <TabsContent value="experiences">
            <div className="space-y-8">
              <ExperienceSection professionSlug="yazilim-test-uzmanligi" />
            </div>
          </TabsContent>
          ...
          <TabsContent value="documents">
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                ...
                <UploadDocumentDialog professionSlug="yazilim-test-uzmanligi" />
              </div>
