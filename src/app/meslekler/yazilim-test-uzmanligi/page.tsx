      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <Card className="relative border-slate-200 dark:border-slate-800 overflow-hidden">
                      ...
                      <CardHeader>
                        <div className="flex items-center gap-4 mb-2">
                          <div className="flex items-center justify-center w-8 h-8 rounded-full bg-orange-100 dark:bg-orange-900/50 text-orange-600 dark:text-orange-400 font-bold text-sm border-4 border-white dark:border-slate-950 shadow-sm z-10">
                            {step.step}
                          </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-gradient-to-br from-orange-600 to-amber-700 text-white border-none shadow-lg sticky top-24">
              <CardHeader>
