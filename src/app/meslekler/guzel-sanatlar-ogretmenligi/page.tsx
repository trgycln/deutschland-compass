...
import { fineArtsTeacherData } from '@/data/fine-arts-teacher-data';
...
export default function FineArtsTeacherPage() {
  const [videoUrl, setVideoUrl] = useState(fineArtsTeacherData.videoUrl);
  const [pageTitle, setPageTitle] = useState(fineArtsTeacherData.title);
  const [pageDescription, setPageDescription] = useState(fineArtsTeacherData.description);
  const [activeTab, setActiveTab] = useState('roadmap');
  const { updates } = useCommunityUpdates('guzel-sanatlar-ogretmenligi');
  ...
  useEffect(() => {
    async function fetchPageData() {
      const { data } = await supabase
        ...
        .eq('slug', 'guzel-sanatlar-ogretmenligi')
        .single();
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start text-center md:text-left">
            <div className="flex-1 space-y-4 w-full">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-4">
                {fineArtsTeacherData.stats.map((stat, index) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-6">
                <a 
                  href="https://t.me/+JQe1tcjigVU5MWJi" 
                  target="_blank" 
                ...
                >
                  ...
                  <div className="relative z-10 flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-white font-semibold text-sm">Güzel Sanatlar Öğretmenleri</div>
              ...
              <div className="flex justify-center md:justify-start gap-3 pt-4">
                ...
                <ShareExperienceDialog professionSlug="guzel-sanatlar-ogretmenligi" />
              </div>
            </div>
      ...
      <div id="roadmap-section" className="container mx-auto px-4 py-8 max-w-5xl">
        <PageCommunityUpdatesBanner 
          categorySlug="guzel-sanatlar-ogretmenligi"
          groupName="GÜZEL SANATLAR ÖĞRETMENLERİ GRUBU" 
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
          ...
          <TabsContent value="updates">
            <PageCommunityUpdatesContent 
              ...
              groupName="GÜZEL SANATLAR ÖĞRETMENLERİ GRUBU"
              telegramUrl="https://t.me/+JQe1tcjigVU5MWJi" 
            />
          </TabsContent>
          ...
          <TabsContent value="roadmap" className="space-y-8">
            <div className="grid gap-8">
              {fineArtsTeacherData.roadmap.map((step, index) => (
              ...
              <Card className="md:col-span-2">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    ...
                    {fineArtsTeacherData.pedagogy.title}
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-300">
                      {fineArtsTeacherData.pedagogy.content}
                    </p>
                  </div>
                  
                  <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-md border border-yellow-100 dark:border-yellow-900/50">
                    <h4 className="font-semibold text-yellow-800 dark:text-yellow-200 mb-2">Özel İhtiyaçlar & Kapsayıcılık</h4>
                    <p className="text-sm text-yellow-700 dark:text-yellow-300">
                      {fineArtsTeacherData.pedagogy.specialNeeds}
                    </p>
                  </div>

                  <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-md border border-blue-100 dark:border-blue-900/50">
                    <h4 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">Kaynaklar & İletişim</h4>
                    <p className="text-sm text-blue-700 dark:text-blue-300">
                      {fineArtsTeacherData.pedagogy.resources}
                    </p>
                  </div>
                </CardContent>
              </Card>
          ...
          <TabsContent value="faq">
            <FaqSection professionSlug="guzel-sanatlar-ogretmenligi" initialFaqs={fineArtsTeacherData.faq} />
          </TabsContent>
          ...
          <TabsContent value="experiences">
            <div className="space-y-8">
              ...
              <ExperienceSection professionSlug="guzel-sanatlar-ogretmenligi" />
            </div>
          </TabsContent>
          ...
          <TabsContent value="documents">
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                ...
                <UploadDocumentDialog professionSlug="guzel-sanatlar-ogretmenligi" />
              </div>
              <DocumentSection professionSlug="guzel-sanatlar-ogretmenligi" />
            </div>
          </TabsContent>
        </Tabs>
      </div>
