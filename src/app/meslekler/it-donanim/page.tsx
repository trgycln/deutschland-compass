...
import { BookOpen, PlayCircle, GraduationCap, School, Briefcase, Users, HeartHandshake, Lightbulb, ArrowLeft, CheckCircle2, AlertCircle, ExternalLink, Database, Server, Layers, Cpu, Printer, ShoppingCart, Wrench } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <Card className="relative border-slate-200 dark:border-slate-800 overflow-hidden">
                      ...
                      <CardHeader>
                        <div className="flex items-center gap-4 mb-2">
                          <div className="flex items-center justify-center w-8 h-8 rounded-full bg-emerald-100 dark:bg-emerald-900/50 text-emerald-600 dark:text-emerald-400 font-bold text-sm border-4 border-white dark:border-slate-950 shadow-sm z-10">
                            {step.step}
                          </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-gradient-to-br from-emerald-600 to-teal-700 text-white border-none shadow-lg sticky top-24">
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                <p className="text-emerald-100">
                  Donanım ve sistem yönetimi konusundaki tecrübeleriniz, yeni başlayanlar için çok değerli. Hikayenizi paylaşarak topluluğa katkıda bulunun.
                </p>
                <ShareExperienceDialog professionId="it-donanim" professionTitle="IT Donanım ve Sistem Yönetimi" />
              </CardContent>
            </Card>
          </div>
        </div>
