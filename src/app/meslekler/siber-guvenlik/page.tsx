...
import { BookOpen, PlayCircle, GraduationCap, Users, HeartHandshake, ArrowLeft, CheckCircle2, ShieldCheck, FileText } from 'lucide-react';
...
export default function CyberSecurityPage() {
  ...
  const { updates } = useCommunityUpdates('siber-guvenlik');
      ...
      <div id="roadmap-section" className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
          ...
          <TabsContent value="faq">
            <FaqSection professionSlug="siber-guvenlik" initialFaqs={faq} />
          </TabsContent>

          {/* Experiences Tab */}
          <TabsContent value="experiences">
            <div className="space-y-8">
              <ExperienceSection professionSlug="siber-guvenlik" />
            </div>
          </TabsContent>
          ...
          <TabsContent value="documents">
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                ...
                <UploadDocumentDialog professionSlug="siber-guvenlik" />
              </div>
              <DocumentSection professionSlug="siber-guvenlik" />
            </div>
          </TabsContent>
        </Tabs>
      </div>
