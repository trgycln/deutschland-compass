...
export default function BusinessPage() {
  ...
  const { updates } = useCommunityUpdates('isletme-iktisat');
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="container mx-auto px-4 py-12 max-w-5xl" id="roadmap-section">
        <PageCommunityUpdatesBanner 
          categorySlug="isletme-iktisat"
          groupName="İşletme-İktisat-Maliye Grubu" 
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8 mt-6">
          ...
          <TabsContent value="updates">
            <PageCommunityUpdatesContent 
              ...
              groupName="İşletme-İktisat-Maliye Grubu"
              telegramUrl="https://t.me/+w2viy2qFczQ0MGUy" 
            />
          </TabsContent>
