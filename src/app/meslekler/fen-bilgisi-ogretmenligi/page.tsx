...
import { scienceTeacherData } from '@/data/science-teacher-data';
...
export default function ScienceTeacherPage() {
  const [videoUrl, setVideoUrl] = useState(scienceTeacherData.videoUrl);
  const [pageTitle, setPageTitle] = useState(scienceTeacherData.title);
  const [pageDescription, setPageDescription] = useState(scienceTeacherData.description);
  const [activeTab, setActiveTab] = useState('roadmap');
  const { updates } = useCommunityUpdates('fen-bilgisi-ogretmenligi');
  ...
  useEffect(() => {
    async function fetchPageData() {
      const { data } = await supabase
        ...
        .eq('slug', 'fen-bilgisi-ogretmenligi')
        .single();
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start text-center md:text-left">
            <div className="flex-1 space-y-4 w-full">
              <div className="flex items-center justify-center md:justify-start gap-2">
                <Badge variant="outline" className="text-emerald-600 border-emerald-200 bg-emerald-50">Eğitim & Fen</Badge>
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-4">
                {scienceTeacherData.stats.map((stat, index) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-6">
                <a 
                  href="https://t.me/+QKtnnUAu8dkxODM6" 
                  target="_blank" 
                ...
                >
                  ...
                  <div className="relative z-10 flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-white font-semibold text-sm">Fen Bilgisi Öğretmenleri</div>
              ...
              <div className="flex justify-center md:justify-start gap-3 pt-4">
                ...
                <ShareExperienceDialog professionSlug="fen-bilgisi-ogretmenligi" />
              </div>
            </div>
      ...
      <div id="roadmap-section" className="container mx-auto px-4 py-8 max-w-5xl">
        <PageCommunityUpdatesBanner 
          categorySlug="fen-bilgisi-ogretmenligi"
          groupName="FEN BİLGİSİ ÖĞRETMENLER GRUBU" 
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
          ...
          <TabsContent value="updates">
            <PageCommunityUpdatesContent 
              ...
              groupName="FEN BİLGİSİ ÖĞRETMENLER GRUBU"
              telegramUrl="https://t.me/+QKtnnUAu8dkxODM6" 
            />
          </TabsContent>
          ...
          <TabsContent value="roadmap" className="space-y-8">
            <div className="grid gap-8">
              {scienceTeacherData.roadmap.map((step, index) => (
              ...
              <Card className="md:col-span-2">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    ...
                    {scienceTeacherData.pedagogy.title}
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-300">
                      {scienceTeacherData.pedagogy.content}
                    </p>
                  </div>
                  ...
                  <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-md border border-yellow-100 dark:border-yellow-900/50">
                    ...
                    <p className="text-sm text-yellow-700 dark:text-yellow-300">
                      {scienceTeacherData.pedagogy.specialNeeds}
                    </p>
                  </div>
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-md border border-blue-100 dark:border-blue-900/50">
                    ...
                    <p className="text-sm text-blue-700 dark:text-blue-300">
                      {scienceTeacherData.pedagogy.resources}
                    </p>
                  </div>
                </CardContent>
              </Card>
          ...
          <TabsContent value="faq">
            <FaqSection professionSlug="fen-bilgisi-ogretmenligi" initialFaqs={scienceTeacherData.faq} />
          </TabsContent>

          {/* Experiences Tab */}
          <TabsContent value="experiences">
            <ExperienceSection professionSlug="fen-bilgisi-ogretmenligi" />
          </TabsContent>
          ...
          <TabsContent value="documents">
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                ...
                <UploadDocumentDialog professionSlug="fen-bilgisi-ogretmenligi" />
              </div>
              <DocumentSection professionSlug="fen-bilgisi-ogretmenligi" />
            </div>
          </TabsContent>
        </Tabs>
      </div>
