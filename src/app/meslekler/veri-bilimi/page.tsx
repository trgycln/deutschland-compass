...
import { BookOpen, PlayCircle, GraduationCap, Users, HeartHandshake, ArrowLeft, CheckCircle2, BarChart3, FileText } from 'lucide-react';
...
export default function DataSciencePage() {
  ...
  const { updates } = useCommunityUpdates('veri-bilimi');
      ...
      <div id="roadmap-section" className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
          ...
          <TabsContent value="faq">
            <FaqSection professionSlug="veri-bilimi" initialFaqs={faq} />
          </TabsContent>

          {/* Experiences Tab */}
          <TabsContent value="experiences">
            <div className="space-y-8">
              <ExperienceSection professionSlug="veri-bilimi" />
            </div>
          </TabsContent>
