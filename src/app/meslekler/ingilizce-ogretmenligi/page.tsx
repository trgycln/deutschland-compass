...
import { englishTeacherData } from '@/data/english-teacher-data';
...
export default function EnglishTeacherPage() {
  const [videoUrl, setVideoUrl] = useState(englishTeacherData.videoUrl);
  const [pageTitle, setPageTitle] = useState(englishTeacherData.title);
  const [pageDescription, setPageDescription] = useState(englishTeacherData.description);
  const [activeTab, setActiveTab] = useState('roadmap');
  const { updates } = useCommunityUpdates('ingilizce-ogretmenligi');
  ...
  useEffect(() => {
    async function fetchPageData() {
      const { data } = await supabase
        ...
        .eq('slug', 'ingilizce-ogretmenligi')
        .single();
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start text-center md:text-left">
            <div className="flex-1 space-y-4 w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-6">
                <a 
                  href="https://t.me/+RgdjMep8p25mODJk" 
                  target="_blank" 
                ...
                >
                  ...
                  <div className="relative z-10 flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-white font-semibold text-sm">İngilizce Öğretmenleri</div>
              ...
              <div className="flex justify-center md:justify-start gap-3 pt-4">
                ...
                <ShareExperienceDialog professionSlug="ingilizce-ogretmenligi" />
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 py-12 max-w-5xl" id="roadmap-section">
        <PageCommunityUpdatesBanner 
          categorySlug="ingilizce-ogretmenligi"
          groupName="İNGİLİZCE ÖĞRETMENLERİ GRUBU" 
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
          <TabsList className="grid w-full grid-cols-2 md:grid-cols-6 lg:w-[860px] h-auto p-1 bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl">
            ...
            <TabsTrigger value="pedagogy" className="py-2.5 rounded-lg">Pedagojik Formasyon</TabsTrigger>
          ...
          <TabsContent value="updates">
            <PageCommunityUpdatesContent 
              ...
              groupName="İNGİLİZCE ÖĞRETMENLERİ GRUBU"
              telegramUrl="https://t.me/+RgdjMep8p25mODJk" 
            />
          </TabsContent>

          <TabsContent value="roadmap" className="space-y-6">
            <div className="grid gap-6">
              {englishTeacherData.roadmap.map((step, index) => (
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  {englishTeacherData.pedagogy.title}
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="prose dark:prose-invert max-w-none">
                  <p className="text-lg leading-relaxed text-slate-700 dark:text-slate-300">
                    {englishTeacherData.pedagogy.content}
                  </p>
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mt-8">
                    <div className="bg-amber-50 dark:bg-amber-950/30 p-6 rounded-xl border border-amber-100 dark:border-amber-900/50">
                      ...
                      <p className="text-amber-800 dark:text-amber-200/80">
                        {englishTeacherData.pedagogy.specialNeeds}
                      </p>
                    </div>
                    ...
                    <div className="bg-blue-50 dark:bg-blue-950/30 p-6 rounded-xl border border-blue-100 dark:border-blue-900/50">
                      ...
                      <p className="text-blue-800 dark:text-blue-200/80">
                        {englishTeacherData.pedagogy.resources}
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <TabsContent value="faq">
            <FaqSection professionSlug="ingilizce-ogretmenligi" initialFaqs={englishTeacherData.faq} />
          </TabsContent>

          <TabsContent value="experiences">
            <ExperienceSection professionSlug="ingilizce-ogretmenligi" />
          </TabsContent>
          ...
          <TabsContent value="documents">
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                ...
                <UploadDocumentDialog professionSlug="ingilizce-ogretmenligi" />
              </div>
              <DocumentSection professionSlug="ingilizce-ogretmenligi" />
            </div>
          </TabsContent>
        </Tabs>
      </div>
