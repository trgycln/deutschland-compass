...
import { BookOpen, PlayCircle, GraduationCap, Users, HeartHandshake, ArrowLeft, CheckCircle2, Database, FileText } from 'lucide-react';
...
export default function SapPage() {
  ...
  const { updates } = useCommunityUpdates('sap-uzmanligi');
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
          ...
          <TabsContent value="updates">
            <PageCommunityUpdatesContent 
              categorySlug="sap-uzmanligi"
              updates={updates} 
              title="SAP Danışmanlığı & Uzmanlığı" 
              groupName="IT Bilişim Grubu"
          ...
          <TabsContent value="faq">
            <FaqSection professionSlug="sap-uzmanligi" initialFaqs={faq} />
          </TabsContent>

          {/* Experiences Tab */}
          <TabsContent value="experiences">
            <div className="space-y-8">
              <ExperienceSection professionSlug="sap-uzmanligi" />
            </div>
          </TabsContent>
