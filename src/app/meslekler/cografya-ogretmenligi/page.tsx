...
export default function GeographyTeacherPage() {
  ...
  const { updates } = useCommunityUpdates('cografya-ogretmenligi');
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start text-center md:text-left">
            <div className="flex-1 space-y-4 w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-6">
                <a 
                  href="https://t.me/+RZW3ra89MPc2Njhi" 
                  target="_blank" 
                ...
                >
                  ...
                  <div className="relative z-10 flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-white font-semibold text-sm">Coğrafya Öğretmenleri</div>
      ...
      <div id="content-section" className="container mx-auto px-4 py-12 max-w-5xl">
        <PageCommunityUpdatesBanner 
          categorySlug="cografya-ogretmenligi"
          groupName="COĞRAFYA ÖĞRETMENLERİ GRUBU" 
        ...
        {/* Analogy Section */}
        {analogy && (
          <div className="my-8 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6 flex gap-4">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
          ...
          <TabsContent value="updates">
            <PageCommunityUpdatesContent 
              ...
              groupName="COĞRAFYA ÖĞRETMENLERİ GRUBU"
              telegramUrl="https://t.me/+RZW3ra89MPc2Njhi" 
            />
          </TabsContent>
