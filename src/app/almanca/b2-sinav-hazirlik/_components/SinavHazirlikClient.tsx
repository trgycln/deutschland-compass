...
import {
  ...
  ChevronRight, Trophy, Flame, ArrowLeft
} from 'lucide-react';
      ...
      <header className="border-b border-stone-200/80 bg-white/85 backdrop-blur-md sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/almanca"
              className="flex items-center gap-1 text-xs font-medium text-slate-600 hover:text-blue-600 transition-colors px-2.5 py-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800"
              title="Almanca ana sayfasına dön"
            >
              <ArrowLeft className="w-3.5 h-3.5" />
              <span className="hidden md:inline">Almanca</span>
            </Link>
            ...
            >
              ...
              <div className="hidden sm:block text-left">
                <p className="text-slate-900 font-bold text-sm leading-tight">B2 Sınav Hazırlığı (ALL DOSYASI)</p>
